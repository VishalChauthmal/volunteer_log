...
describe "Julhour Pages" do
	...
	describe "new" do
		...
		describe "with user signing in" do
			...
			describe "with a date that's in the future" do
				before do
					fill_in "Date", with: Date.parse((Date.today + 1.year).strftime("%Y-07-%d"))
	...
	describe "edit" do
		...
		before do
			sign_in user
			@julhour = user.julhours.create(date: "2013-07-01", numhours: 4.67)
